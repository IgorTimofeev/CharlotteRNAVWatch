...
namespace pizda {
	...
	RGB565Color Theme::purple1 { 0 };
	RGB565Color Theme::purple2 { 0 };
	...
	const unscii8ThinFont Theme::fontBig {};
	...
	void Theme::setCommon() {
		...
		purple1 = RGB888Color(0xff00ff).toRGB565();
		purple2 = RGB888Color(0x831683).toRGB565();
