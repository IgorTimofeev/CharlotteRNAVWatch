...
namespace pizda {
	...
	class Eblo : public Control {
		...
		private:
			...
			constexpr static uint8_t sidebarSize = 24;

			constexpr static uint8_t verticalBarSize = 46;

			// Compass
			constexpr static uint8_t compassDiameter = displayDiameter - sidebarSize * 2;
			...
			constexpr static uint8_t speedValueWidth = sidebarSize + 10;
